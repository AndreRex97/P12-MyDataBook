...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<String> drawer = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer.add("Bio");
        drawer.add("Vaccination");
        drawer.add("Anniversary");
        drawer.add("About Us");

        ab = getSupportActionBar();

        aa = new DataBook(this,android.R.layout.simple_list_item_activated_1, drawer);
        ...
        drawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int
                ...
                currentTitle = drawer.get(position);
